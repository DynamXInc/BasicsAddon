...
public class EventHandler
{
    ...
    public static void initVehicleModules(PhysicsEntityEvent.CreateEntityModulesEvent<BaseVehicleEntity> event)
    {
        ...
        event.getModuleList().add(new fr.dynamx.addons.basics.common.modules.BasicsAddonModule(entity, info)); //don't care of null info, module is used by keys system anyway
    }
    ...
    public static void interactWithCar(VehicleEntityEvent.VehicleInteractEntityEvent event) {
        ...
        {
            fr.dynamx.addons.basics.common.modules.BasicsAddonModule module = event.getEntity().getModuleByType(BasicsAddonModule.class);
